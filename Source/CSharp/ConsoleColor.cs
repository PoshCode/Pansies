...
namespace Poshcode.Ansi
{
    ...
    {
        public static string GetCode(this System.ConsoleColor? color, bool forBackground = false)
        {
        ...
        public static string WriteAnsi(System.ConsoleColor? foreground, System.ConsoleColor? background, string value, bool clear = false)
        {
